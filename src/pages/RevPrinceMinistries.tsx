...
export default function RevPrinceMinistries() {
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden" data-fhc-animate>

      {/* Hero Section */}
      <section className="relative h-[70vh] overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900" data-fhc-section data-fhc-parallax-bg>
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4 z-10">
          <div className="mb-6" data-fhc-copy>
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-4 leading-tight" data-fhc-heading>
            Rev. Prince <br className="hidden md:block" /> Ministries
          </h1>
          <p className="max-w-2xl mt-4 text-lg md:text-xl text-blue-100 font-light leading-relaxed" data-fhc-copy>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Button asChild size="lg" className="inline-flex items-center justify-center rounded-full bg-amber-400 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-amber-500/30 transition hover:-translate-y-0.5">
              <Link to="/contact" data-fhc-button>Get In Touch</Link>
            </Button>
            <Button asChild size="lg" className="inline-flex items-center justify-center rounded-full border border-white/30 px-6 py-3 text-sm font-semibold text-white hover:border-amber-300 transition hover:-translate-y-0.5">
              <Link to="/partnership" data-fhc-button>Partner With Us</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, idx) => {
              ...
              return (
                <div key={idx} className="text-center text-white" data-fhc-stat>
      ...
      {/* Profile Section */}
      <section className="py-20 bg-white" data-fhc-section>
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative" data-fhc-parallax-card>
            ...
            <div>
              <div className="inline-block px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-4" data-fhc-copy>
                About The Leader
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6" data-fhc-heading>
                Rev. Prince
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6" data-fhc-copy>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8" data-fhc-copy>
              ...
              <blockquote className="border-l-4 border-blue-600 pl-6 py-4 bg-blue-50 rounded italic text-gray-800 font-semibold text-lg" data-fhc-copy>
              ...
              <div className="mt-8 flex gap-4">
                <Button asChild className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-lg font-bold hover:shadow-lg">
                  <a href="https://wa.me/233243527174?text=Hello%20Rev.%20Prince%2C%20I%20would%20like%20to%20invite%20you%20for%20ministry." target="_blank" rel="noreferrer" data-fhc-button>Invite For Ministry</a>
                </Button>
                <Button asChild variant="outline" className="px-8 py-3 rounded-lg font-bold">
                  <Link to="/partnership" data-fhc-button>Learn More</Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      {/* Timeline Section */}
      <section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50" data-fhc-section>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-4" data-fhc-heading>Journey of a Servant</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto" data-fhc-copy>20 Years of faithfulness, growth, and ministry transformation</p>
          </div>

          <div className="max-w-4xl mx-auto">
            {timeline.map((item, idx) => (
              <div key={idx} className="flex gap-6 mb-8 relative" data-fhc-card>
                ...
                <div className="flex-1 pb-8">
                  <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all border-l-4 border-blue-600">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-2xl font-black text-blue-600" data-fhc-heading>{item.year}</h3>
                      <span className="text-xs font-bold text-gray-500 bg-gray-100 px-3 py-1 rounded-full">{item.scripture}</span>
                    </div>
                    <p className="text-lg text-gray-800 font-semibold" data-fhc-copy>{item.event}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-white" data-fhc-section>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-4" data-fhc-heading>Ministry Domains</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto" data-fhc-copy>Six pillars of spiritual impact and transformation</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ministries.map((ministry, idx) => {
              ...
              return (
                <div key={idx} className="group relative" data-fhc-card>
                  ...
                  <div className="relative bg-white rounded-2xl p-8 shadow-lg group-hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-3" data-fhc-heading>{ministry.title}</h3>
                    <p className="text-gray-600 leading-relaxed flex-grow" data-fhc-copy>{ministry.desc}</p>
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <button className="text-blue-600 font-semibold text-sm hover:text-blue-700 transition-colors" data-fhc-button>
                        Learn More →
                      </button>
                    </div>
                  </div>
      ...
      {/* Invitation Section */}
      <section className="py-20 bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 relative overflow-hidden" data-fhc-section>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6" data-fhc-heading>Invite Rev. Prince</h2>
          <p className="max-w-3xl mx-auto text-lg text-blue-100 mb-10 leading-relaxed" data-fhc-copy>
          ...
          <Button asChild size="lg" className="bg-white text-blue-700 font-bold px-10 py-4 hover:bg-blue-50 transition-all hover:scale-105 shadow-2xl">
            <Link to="/contact" data-fhc-button>Make An Invitation</Link>
          </Button>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div key={idx} className="text-center p-8 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 hover:border-blue-400 transition-all" data-fhc-card>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-2" data-fhc-heading>{contact.title}</h3>
                  <p className="text-gray-700 font-semibold" data-fhc-copy>{contact.info}</p>
                </div>
              );
            })}
          </div>
          <div className="mt-12 text-center">
            <Button asChild size="lg" className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-10 py-4 rounded-xl font-bold hover:shadow-lg">
              <Link to="/contact" data-fhc-button>Send A Message</Link>
            </Button>
          </div>
        </div>
      </section>
